...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \vspace{-2pt}
    \item{
      \textbf{Courses}{: Introduction to Machine Learning for Engineers, Practical Data Science, Foundations of Computer Systems}
    }
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: Python, Java, C, Shell, JavaScript, SQL}
    }
    \item{
      \textbf{Technologies}{: NumPy, Pandas, scikit-learn, Docker, Linux}
    }
  \resumeSubHeadingListEnd
