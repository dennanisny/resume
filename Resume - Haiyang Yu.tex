...
\section{Technical Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: C, Java, Python, Shell, SQL}
    }
    \item{
      \textbf{Technologies}{: Android, Docker, Linux, Ceph, Consul, Registrator, Protocol Buffers, gRPC, Google Guava, NumPy, Pandas}
    }
  \resumeSubHeadingListEnd
